...
export async function createUserWithEmailAndPassword({
  ...
  const emailOptions = {
    email,
    subject: "Welcome to Abiero Kanban! Confirm Your Email Address",
    message: `
    ...
    <p style="color: #737373; margin-bottom: 15px;">Greetings from Alvin Abiero! We're thrilled to have you join our community.</p>
    ...
    <p style="color: #737373; font-weight: bold;">If you didn't sign up for Abiero Kaban, no worries! Simply ignore this email.</p>
  </div>
    `,
  };
